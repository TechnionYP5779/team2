...
public class isTest {
  @SuppressWarnings("static-method") @Test public void inEmptyListReturnsFasle() {
  ...
  @SuppressWarnings("static-method") @Test public void inReturnsFasleForNullItem() {
    Assert.assertFalse(is.in(null, "", Integer.valueOf(5), Boolean.valueOf(false), null));
  }

  @SuppressWarnings("static-method") @Test public void inReturnsTrueForExistingItem() {
  ...
  @SuppressWarnings("static-method") @Test public void inReturnsFalseForMissingItem() {
  ...
  @SuppressWarnings("static-method") @Test public void intIsInEmptyListReturnsFasle() {
  ...
  @SuppressWarnings("static-method") @Test public void intIsInReturnsTrueForExistingItem() {
  ...
  @SuppressWarnings("static-method") @Test public void intIsInReturnsFalseForMissingItem() {
  ...
  @SuppressWarnings("static-method") @Test public void notInEmptyListReturnsTrue() {
  ...
  @SuppressWarnings("static-method") @Test public void notInReturnsFasleForNullItem() {
    Assert.assertTrue(is.not.in(null, "", Integer.valueOf(5), Boolean.valueOf(false), null));
  }

  @SuppressWarnings("static-method") @Test public void notInReturnsTrueForExistingItem() {
  ...
  @SuppressWarnings("static-method") @Test public void notInReturnsFalseForMissingItem() {
  ...
  @SuppressWarnings("static-method") @Test public void outEmptyListReturnsTrue() {
  ...
  @SuppressWarnings("static-method") @Test public void outReturnsFasleForNullItem() {
    Assert.assertTrue(is.out(null, "", Integer.valueOf(5), Boolean.valueOf(false), null));
  }

  @SuppressWarnings("static-method") @Test public void outReturnsTrueForExistingItem() {
  ...
  @SuppressWarnings("static-method") @Test public void outReturnsFalseForMissingItem() {
  ...
  @SuppressWarnings("static-method") @Test public void emptyReturnsTrueForNull() {
  ...
  @SuppressWarnings("static-method") @Test public void emptyReturnsTrueForEmptyString() {
    Assert.assertTrue(is.empty(""));
  }

  @SuppressWarnings("static-method") @Test public void emptyReturnsTrueForEmptyArray() {
    Assert.assertTrue(is.empty(new Integer[0]));
    Assert.assertTrue(is.empty(new Object[0]));
  }

  @SuppressWarnings("static-method") @Test public void emptyReturnsTrueForEmptyIterable() {
  ...
  @SuppressWarnings("static-method") @Test public void emptyReturnsTrueForEmptyCollection() {
