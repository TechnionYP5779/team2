...
@SuppressWarnings({"static-method", "static-access"}) public class IntTest {
  ...
  @Test public void valueOfTest3() {
    azzert.assertEquals((new Int(Integer.MAX_VALUE)).inner(), Int.valueOf(Integer.MAX_VALUE).inner());
  }
  ...
  @Test public void valueOfTest5() {
    azzert.assertEquals((new Int(Integer.MIN_VALUE)).inner(), Int.valueOf(Integer.MIN_VALUE).inner());
  }
