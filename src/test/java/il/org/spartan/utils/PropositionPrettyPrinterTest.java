...
public class PropositionPrettyPrinterTest {
  ...
  @Test public void testMain(){
    ...
    final String main_output = "1) (And) MAIN, SUB1 ==> Assertion exception" + endline + "\t1.1)  X ==> Assertion exception" + endline + "\t1.2)  F ==> false" + endline
        ...
        + "\t\t\t1.3.2.1)  N ==> Null pointer exception" + endline + "\t\t1.3.3)  ==> true" + endline + "\t\t1.3.4)  OH NO ==> Runtime exception"
        + endline + endline + "1) (And) MAIN ==> true" + endline + "\t1.1) (Or) SUB ==> true" + endline + "\t\t1.1.1)  T ==> true" + endline
        + "\t\t1.1.2)  F ==> false" + endline + "\t1.2)  T ==> true" + endline + endline + "1)  MAIN ==> true" + endline + "\t1.1)  T ==> true"
        + endline + endline + "1) (And) [SUB, T] ==> true" + endline + "\t1.1) (Or) SUB ==> true" + endline + "\t\t1.1.1)  T ==> true" + endline
        + "\t\t1.1.2)  F ==> false" + endline + "\t1.2)  T ==> true" + endline + endline + "1) (And) [F, X] ==> false" + endline
        + "\t1.1)  F ==> false" + endline + "\t1.2)  X ==> Assertion exception" + endline + endline + "1) (Or) SUB2 ==> true" + endline
        + "\t1.1)  T ==> true" + endline + "\t1.2) (Not) N ==> Null pointer exception" + endline + "\t\t1.2.1) (Not) N ==> Null pointer exception"
        + endline + "\t\t\t1.2.1.1)  N ==> Null pointer exception" + endline + "\t1.3)  ==> true" + endline + "\t1.4)  OH NO ==> Runtime exception"
        + endline + endline;
