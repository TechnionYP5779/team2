...
@SuppressWarnings("static-method") public class BigIntegerTest {
  ...
  @Test public void testNegative() {
    Assert.assertEquals(new BigInteger("10").negate(), new BigInteger("-10"));
  }

  @Test public void testNegative2() {
    Assert.assertEquals(new BigInteger("1234567890123456789012345678901234567890").negate(),
        new BigInteger("-1234567890123456789012345678901234567890"));
  }

  @Test public void testNegative3() {
    Assert.assertEquals(new BigInteger("175688854").negate(), new BigInteger("-175688854"));
  }
