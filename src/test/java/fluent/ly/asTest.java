...
public class asTest {
  @Test @SuppressWarnings("null") public void asIterableTest1() {
    ...
    int i = 0;
    for (final Integer f : as.asIterable(fluent.ly.box.it(1), fluent.ly.box.it(2), fluent.ly.box.it(3),
        fluent.ly.box.it(4), fluent.ly.box.it(5)))
  ...
  @Test @SuppressWarnings("null") public void asIterableTest2() {
    final int[] res = new int[] { 1, 2, 3, 2, 4, 6, 3, 6, 9, 4, 8, 12, 5, 10, 15 };
    int i = 0;
    for (final Integer f : as.asIterableLambda(fluent.ly.box.it(1), fluent.ly.box.it(2), fluent.ly.box.it(3),
        fluent.ly.box.it(4), fluent.ly.box.it(5)))
  ...
  @Test public void listTest4() {
    final List<Boolean> lst7 = as.list(Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, 
  ...
  @Test  public void iteratorTest1() {
    final Iterator<Integer> int_iter = as.iterator(fluent.ly.box.it(1), fluent.ly.box.it(2), fluent.ly.box.it(3), 
        fluent.ly.box.it(4), fluent.ly.box.it(5));
    for (int ¢ = 1; ¢ < 6; ++¢) {
  ...
  @Test  public void iteratorTest2() {
    final Iterator<Boolean> bool_iter = as.iterator(fluent.ly.box.it(true), fluent.ly.box.it(false), 
        fluent.ly.box.it(true), fluent.ly.box.it(false));
    boolean b = true;
    for (int ¢ = 1; ¢ < 5; ++¢) {
  ...
  @Test @SuppressWarnings("null") public void setTest() {
    @SuppressWarnings("unchecked") final Set<Integer> s1 = (Set<Integer>) as.set(fluent.ly.box.it(1), fluent.ly.box.it(2), fluent.ly.box.it(3), fluent.ly.box.it(4), fluent.ly.box.it(5), fluent.ly.box.it(6), fluent.ly.box.it(7), fluent.ly.box.it(8), fluent.ly.box.it(9), fluent.ly.box.it(10));
    for (int ¢ = 0; ¢ < 10; ++¢) {
    ...
    @SuppressWarnings("unchecked") final Set<Boolean> s3 = (Set<Boolean>) as.set(fluent.ly.box.it(true), fluent.ly.box.it(false), fluent.ly.box.it(true), fluent.ly.box.it(true), fluent.ly.box.it(false), fluent.ly.box.it(false));
    azzert.assertContains(s3, fluent.ly.box.it(true));
    azzert.assertContains(s3, fluent.ly.box.it(false));
    @SuppressWarnings("unchecked") final Set<Boolean> s4 = (Set<Boolean>) as.set(fluent.ly.box.it(true), fluent.ly.box.it(true), fluent.ly.box.it(true), fluent.ly.box.it(true));
  ...
  @Test @SuppressWarnings("null") public void asIterableEssenceTest() {
    // azzert.assertEquals(iter.iterator().hasNext(), true);
     final Iterable<Integer> iter = as.asIterableEssence(fluent.ly.box.it(1), fluent.ly.box.it(2), fluent.ly.box.it(3), 
        fluent.ly.box.it(4), fluent.ly.box.it(5));
