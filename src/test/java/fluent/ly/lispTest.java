...
@SuppressWarnings("static-method") public class lispTest {
  ...
  @Test public void testChop2() {
    ...
    l.add(box(2));
    l.add(box(3));
    azzert.that(cantBeNull(lisp.chop(l)).get(0), is(box(2)));
  }

  @Test public void testCons() {
    final List<Integer> l = new ArrayList<>();
    l.add(box(1));
    azzert.that(lisp.cons(box(3), l).get(0), is(box(3)));
  }

  @Test @SuppressWarnings("null") public void testNext1() {
    final List<@Nullable Integer> l = new ArrayList<>();
    l.add(box(1));
    azzert.that(lisp.next(2, l), is(box(1)));
  }
  ...
  @Test @SuppressWarnings("null") public void testNext2() {
    ...
    l.add(box(2));
    l.add(box(3));
    azzert.that(lisp.next(1, l), is(box(3)));
  }
  ...
  @Test @SuppressWarnings("null") public void testGet2() {
    ...
    l.add(box(2));
    l.add(box(3));
    azzert.that(cantBeNull(lisp.get(l, 1)), is(box(3)));
  }
  ...
  @Test @SuppressWarnings("null") public void testPrev1() {
    ...
    l.add(box(2));
    l.add(box(3));
    azzert.that(lisp.prev(0, l), is(box(1)));
  }
  ...
  @Test @SuppressWarnings("null") public void testPrev2() {
    ...
    l.add(box(2));
    l.add(box(3));
    azzert.that(lisp.prev(2, l), is(box(2)));
  }
  ...
  @Test public void testReplace1() {
    ...
    l.add(box(2));
    l.add(box(3));
    assert lisp.replace(l, box(10), -1) == l;
  }
  ...
  @Test public void testReplace2() {
    ...
    l.add(box(2));
    l.add(box(3));
    assert lisp.replace(l, box(10), 100) == l;
  }
  ...
  @Test public void testReplace3() {
    ...
    l.add(box(2));
    l.add(box(3));
    assert lisp.replace(l, box(10), 2) == l;
  }
  ...
  @Test public void testReplaceFirst() {
    ...
    l.add(box(2));
    l.add(box(3));
    azzert.isNull(lisp.replaceFirst(null, box(10)));
  }
  ...
  @Test public void testReplaceLast() {
    ...
    l.add(box(2));
    l.add(box(3));
    azzert.that(cantBeNull(lisp.replaceLast(l, box(10))).get(l.size() - 1), is(box(10)));
  }
  ...
  @Test public void testAreEqual2() {
    assert lisp.areEqual(box(1), box(1));
  }

  @Test public void testAreEqual3() {
    assert !lisp.areEqual(box(1), box(2));
  }
  ...
  @Test public void testChopLastListOfT() {
    ...
    l.add(box(2));
    l.add(box(3));
    azzert.that(lisp.chopLast(l).get(l.size() - 2), is(box(2)));
  }
  ...
  @Test public void testRemoveLast() {
    ...
    l.add(box(3));
    lisp.removeLast(l);
    azzert.that(l.get(l.size() - 1), is(box(2)));
  }
